...
export const SEED_NOTIFS: SeedNotification[] = [
  { id: 1, title: "Payroll delivered", sub: "5 employees paid · verified · Just now", color: "#5fe3ab", read: false, tone: "ok" },
  { id: 3, title: "Upcoming payout", sub: "Jul 31 · 5 employees scheduled · Yesterday", color: "#9db3aa", read: false, tone: "info" },
];
