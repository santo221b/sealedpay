 ...
 * the sphere itself is almost clean (a soft fill, a rim, two faint turning
 * meridians) — the detail lives OUTSIDE, in the drifting orbit rings and one
    ...
    >
      ...
      <svg viewBox="0 0 1150 1150" width="1150" height="1150" fill="none" className="absolute inset-0">
        ...
        <g style={{ transformOrigin: "575px 575px" }}>
          ...
          />
          <ellipse
            cx="575" cy="575" rx="352" ry="212" stroke="rgba(95,230,175,0.08)" strokeWidth="0.9"
        ...
        <g style={{ transformOrigin: "575px 575px" }}>
          ...
          <g style={{ transformOrigin: "575px 575px", animation: reduced ? undefined : "sp-globe-turn 40s linear infinite" }}>
            ...
            <ellipse cx="575" cy="575" rx={215 * 0.85} ry="215" stroke="rgba(120,233,192,0.07)" strokeWidth="0.8" />
          </g>
        </g>
      </svg>
    </motion.div>
